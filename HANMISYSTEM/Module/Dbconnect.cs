...
namespace HANMISYSTEM
{
    public class Dbconnect
    {
        ...
        public SqlConnection con = new SqlConnection(@"Data Source=117.7.227.189,1433;Initial Catalog=HANMI;Trusted_Connection=no;uid = sa;pwd= Hanmi@123;  Integrated Security=false ;Connect Timeout=30");
